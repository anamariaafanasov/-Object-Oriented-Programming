...
Player4::Player4(int x, int y, int tr):Player(x,y,tr)
{
...
coordonate Player4::get_next_position(map_matrix *m)
{
    // functie ce determina urmatoarea pozitie pe care se poate deplasa player4:
    //pozitia e de tip coordonate;
    //deplasare:stanga,sus,dreapta,jos,diagonale:dreapta-jos,stanga-sus,dreapta-jos,stanga-sus
   ...
   coordonate next_position;
    ...
    {
        cout<<"No more valid moves for Player4"<<endl;
        next_position.i=-2;
        next_position.j=-2;
    }
